...
const SIGNAL_SERVER = import.meta.env.VITE_SIGNAL_SERVER || (import.meta.env.PROD ? 'https://direct-drop-kvmukux16-adityas-projects-c8b8f770.vercel.app' : 'http://localhost:3001')
